    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td data-label="Option"><button class="edit-button" onclick="location.href='downloadables_edit.php?id=<?php echo $row['id']?>'">Edit</button><button class="delete-button" onclick="location.href='downloadables_delete.php?id=<?php echo $row['id']?>'">Delete</button></td>
            </tr>
        </tbody>
        <?php
            }
